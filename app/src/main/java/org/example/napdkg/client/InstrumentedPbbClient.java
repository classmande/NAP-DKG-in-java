...
// bytesSent = bytesReceived = publishes = fetches = deletes = 0;
// }
...
// public synchronized String prettySummary() {
// return String.format(
// "=== PBB comms ===%n" +
// "Publishes: %d | Fetches: %d | Deletes: %d%n" +
// "Up: %s | Down: %s%n",
// publishes, fetches, deletes,
// humanBytes(bytesSent), humanBytes(bytesReceived));
// }
